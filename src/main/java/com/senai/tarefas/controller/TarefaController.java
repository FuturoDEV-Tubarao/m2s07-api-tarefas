...
public class TarefaController {
    ...
    public ResponseEntity<TarefaResponse> inserir(@RequestBody TarefaInclusaoRequest request) {
        var tarefa = new Tarefa(request.getDescricao(), request.getDataEntrega(), 
            request.getDataInicio(), request.getResponsavel(), request.getPrioridade());
    ...
    @PutMapping("{id}")
    public ResponseEntity<TarefaResponse> atualizar(@PathVariable Integer id, 
                                                @RequestBody TarefaAtualizacaoRequest request) {
        try {
            var tarefa = new Tarefa(request.getDescricao(), request.getDataEntrega(), 
